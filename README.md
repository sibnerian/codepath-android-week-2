...
**OMG NYT** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] Run network requests in an async task with a sleep() call to avoid the NYT rate limit.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/u86uZ0g.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
